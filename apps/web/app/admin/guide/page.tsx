                    ...
                    <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <ol className="text-[var(--text-secondary)] text-sm space-y-3">
                                    <li className="flex items-start gap-3">
                                        <span className="w-6 h-6 rounded-full bg-[var(--bg-elevated)] flex items-center justify-center text-xs font-medium shrink-0">1</span>
                                        <span>Go to <strong>Contests → Create</strong> and fill in the contest details (title, description, type)</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-6 h-6 rounded-full bg-[var(--bg-elevated)] flex items-center justify-center text-xs font-medium shrink-0">2</span>
                                        <span>Set the status to <strong>UPCOMING</strong> (scheduled) or <strong>LIVE</strong> (starts immediately)</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-6 h-6 rounded-full bg-[var(--bg-elevated)] flex items-center justify-center text-xs font-medium shrink-0">3</span>
                                        <span>Add questions manually or use <strong>Create with AI</strong> to generate them automatically</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="w-6 h-6 rounded-full bg-[var(--bg-elevated)] flex items-center justify-center text-xs font-medium shrink-0">4</span>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <div className="p-3 rounded-lg bg-[var(--bg-secondary)] text-sm text-[var(--text-muted)]">
                                ...
                                <div className="grid gap-3">
                                    <div className="p-3 rounded-lg bg-[var(--bg-secondary)]">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="text-xs px-2 py-0.5 rounded bg-[var(--bg-elevated)] text-[var(--text-primary)]">LIVE</span>
                                            <span className="text-sm font-medium text-[var(--text-primary)]">Real-time Competition</span>
                                        </div>
                                    ...
                                    <div className="p-3 rounded-lg bg-[var(--bg-secondary)]">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="text-xs px-2 py-0.5 rounded bg-[var(--bg-elevated)] text-[var(--text-primary)]">Practice</span>
                                            <span className="text-sm font-medium text-[var(--text-primary)]">Self-paced Learning</span>
                                        </div>
                                        <p className="text-xs text-[var(--text-muted)]">
