        ...
        <div className="container py-8">
            ...
            <div className="flex items-end justify-center gap-4 mb-12">
                ...
                <div className="text-center">
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-linear-to-br from-gray-400 to-gray-500 flex items-center justify-center mx-auto mb-3 text-white font-bold text-2xl">
                        {top3[1]?.userName.charAt(0)}
                    </div>
                    <Medal className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                    <p className="font-semibold text-primary">{top3[1]?.userName}</p>
                    <p className="text-sm text-muted">{top3[1]?.totalPoints.toLocaleString()} pts</p>
                    <div className="w-20 md:w-28 h-24 bg-linear-to-t from-gray-600/50 to-gray-500/30 rounded-t-xl mt-4 flex items-center justify-center">
                ...
                {/* 1st Place */}
                <div className="text-center">
                    <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-linear-to-br from-yellow-400 to-amber-500 flex items-center justify-center mx-auto mb-3 text-white font-bold text-3xl ring-4 ring-yellow-400/30">
                        {top3[0]?.userName.charAt(0)}
                    </div>
                    <Trophy className="w-10 h-10 text-yellow-400 mx-auto mb-2" />
                    <p className="font-bold text-lg text-primary">{top3[0]?.userName}</p>
                    <p className="text-sm text-muted">{top3[0]?.totalPoints.toLocaleString()} pts</p>
                    <div className="w-24 md:w-32 h-32 bg-linear-to-t from-yellow-600/50 to-yellow-500/30 rounded-t-xl mt-4 flex items-center justify-center">
                ...
                {/* 3rd Place */}
                <div className="text-center">
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-linear-to-br from-amber-600 to-amber-700 flex items-center justify-center mx-auto mb-3 text-white font-bold text-2xl">
                        {top3[2]?.userName.charAt(0)}
                    </div>
                    <Medal className="w-8 h-8 text-amber-600 mx-auto mb-2" />
                    <p className="font-semibold text-primary">{top3[2]?.userName}</p>
                    <p className="text-sm text-muted">{top3[2]?.totalPoints.toLocaleString()} pts</p>
                    <div className="w-20 md:w-28 h-16 bg-linear-to-t from-amber-700/50 to-amber-600/30 rounded-t-xl mt-4 flex items-center justify-center">
